...
function M.setup()
    local rhs = "<Cmd>set operatorfunc=v:lua.require'core.commenter'.toggle<CR>g@"
    vim.keymap.set("n", "gc", rhs, { desc = "Toggle Comment" })
    vim.keymap.set("x", "gc", rhs, { desc = "Toggle Comment" })
end
